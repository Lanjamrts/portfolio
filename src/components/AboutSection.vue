        ...
        <div class="about-text">
          ...
          <div class="description">
            <p class="main-description">
              Passionné par le développement web et les technologies modernes, je suis actuellement étudiant en Génie
              Logiciel à l'INSI Ambanidia.
              Mon objectif est de créer des applications web performantes et des expériences utilisateur
              exceptionnelles.
            </p>
            ...
            <div class="detail-card">
              ...
              <div class="detail-content">
                <div class="education-item">
                  <div class="education-year">2023 - Présent</div>
          ...
          <div class="cta-section">
            <p class="cta-text">Je recherche activement un stage pour mettre en pratique mes compéte nces et contribuer
            ...
            <div class="cta-buttons">
              ...
              <a href="/cv-lanja.pdf" class="btn btn-secondary" download>
