  ...
  <footer class="footer">
    ...
    <div class="container">
      ...
      <div class="footer-bottom" data-aos="fade-up" data-aos-delay="400">
        <div class="copyright">
          <p>&copy; {{ currentYear }} Lanja ANDRIANJATOVO.</p>
        </div>

        <div class="footer-social">
          <a v-for="social in socialLinks" :key="social.icon" :href="social.url" :target="social.target"
            :title="social.title" class="social-link">
