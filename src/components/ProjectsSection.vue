  ...
  <section id="projects" class="projects-section">
    <div class="container">
      ...
      <div class="projects-grid">
        <div class="project-card" v-for="project in projects" :key="project.id" :data-category="project.category">
    ...
    data() {
      return {
          projects: [{
              ...
              image: 'https://unsplash.com/photos/vegetable-stand-photo-pRJhn4MbsMM',
              demoUrl: '#',
              rating: 5,
              date: 'Décembre 2023',
              status: 'completed',
          ...
          },
          {
            ...
            description: 'Application web de gestion de tâches collaborative avec interface moderne, gestion d\'équipes et suivi de productivité en temps réel.',
            category: 'web',
          ...
          {
            id: 5,
            title: 'Application Mobile Social',
            description: 'Application de geolocalisation des incidents urbains ',
            category: 'mobile',
            technologies: ['React Native', 'MongoDB', 'Express', 'Socket.io'],
            ...
            features: [
              'Pris de photo d incident',
              'Partage multimédia',
              'Notifications (,en attente,en cours,effectué)',
              'Géolocalisation'
            ]
          }
        ]
